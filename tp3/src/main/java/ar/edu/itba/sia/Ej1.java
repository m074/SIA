...
public class Ej1 {
    public static void main(String[] args){
        ...
        SimplePerceptron2 AndPerceptron = new SimplePerceptron2(0 ,0.01, inputs, andOutputs, new Sign());
        ...
        while(flag){
            ...
            switch(choice){
                case "teach": AndPerceptron.train(10000, 1000); break;
                case "predict":
                    AndPerceptron.prediction();
                    /*Neuron n = AndPerceptron.getBest();
